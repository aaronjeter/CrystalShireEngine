	...
	const WHIRLISLANDB1F_HELIX_FOSSIL
...
WhirlIslandB1F_MapEvents:
	...
	object_event 31, 12, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, WhirlIslandB1FHelixFossil, EVENT_GOT_FOSSIL_HELIX_WHIRL_ISLAND
