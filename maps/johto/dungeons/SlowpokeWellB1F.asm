...
TrainerGruntM29:
	trainer GRUNTM, GRUNTM_EASY, EVENT_BEAT_ROCKET_GRUNTM_29, GruntM29SeenText, GruntM29BeatenText, 0, .Script
...
TrainerGruntM2:
	trainer GRUNTM, GRUNTM_EASY, EVENT_BEAT_ROCKET_GRUNTM_2, GruntM2SeenText, GruntM2BeatenText, 0, .Script
