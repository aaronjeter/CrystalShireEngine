...
Route3_MapEvents:
	...
	def_bg_events
	bg_event 46, 12, BGEVENT_READ, Route3MtMoonSquareSign
	...
	object_event 50,  7, SPRITE_FISHER, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 3, TrainerFirebreatherBurt, -1
