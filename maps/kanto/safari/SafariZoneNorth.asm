...
.SilverLeaf
	...
	writetext MewShrineFirstMonText
	waitbutton
	yesorno
	iffalse .No
	...
	waitsfx
	writetext MewShrineAlignedWithGhostsText
	waitbutton
	sjump .Done
...
.GoldLeaf
	...
	playsound SFX_CAUGHT_MON
	waitsfx
	writetext MewShrineEtherialBlessingText
	waitbutton
	sjump .Done
...
.MarvelScale
	...
	playsound SFX_CAUGHT_MON
	waitsfx
	writetext MewShrineMewBlessingText
	waitbutton
	sjump .Done	

.No
	writetext MewShrineNoOfferingText
	waitbutton
.Done
	closetext
	end
...
MewShrineFirstMonText:
	text "Offer this item"
	line "for your first"
	cont "#mon?"
	done

MewShrineAlignedWithGhostsText:
	text "Your first #mon"
	line "has aligned"
	cont "with Ghosts!"
	done

MewShrineEtherialBlessingText:
	text "Your first #mon"
	line "has recieved the"
	cont "Etherial Blessing!"
	done

MewShrineMewBlessingText:
	text "Your first #mon"
	line "has recieved a"
	cont "Blessing from"
	cont "Mew!"
...
SafariZoneNorth_MapEvents:
	...
	def_bg_events	
	bg_event 34, 30, BGEVENT_UP, MewShrineScript
