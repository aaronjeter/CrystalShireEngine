...
CeruleanCity_MapEvents:
	...
	warp_event 13, 29, CERULEAN_BIKE_SHOP, 2
	...
	object_event  7, 12, SPRITE_YOUNGSTER, SPRITEMOVEDATA_SPINRANDOM_SLOW, 1, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, CeruleanCityYoungsterScript, -1
