...
BattleTowerOutside_MapEvents:
	...
	warp_event  8, 15, BATTLE_TOWER_1F, 1
	warp_event  9, 15, BATTLE_TOWER_1F, 2

	def_coord_events

	def_bg_events
	bg_event 10, 18, BGEVENT_READ, BattleTowerOutsideSign

	def_object_events
	object_event  2, 17, SPRITE_STANDING_YOUNGSTER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, BattleTowerOutsideYoungsterScript, -1
	object_event 17, 11, SPRITE_BEAUTY, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, BattleTowerOutsideBeautyScript, -1
