...
PoochyenaIcon::  INCBIN "gfx/icons/pikachu.2bpp"
MightyenaIcon::  INCBIN "gfx/icons/pikachu.2bpp"
ZigzagoonIcon::  INCBIN "gfx/icons/pikachu.2bpp"
LinooneIcon::    INCBIN "gfx/icons/pikachu.2bpp"
WurmpleIcon::    INCBIN "gfx/icons/pikachu.2bpp"
SilcoonIcon::    INCBIN "gfx/icons/pikachu.2bpp"
BeautiflyIcon::  INCBIN "gfx/icons/pikachu.2bpp"
CascoonIcon::    INCBIN "gfx/icons/pikachu.2bpp"
DustoxIcon::     INCBIN "gfx/icons/pikachu.2bpp"
LotadIcon::      INCBIN "gfx/icons/pikachu.2bpp"
LombreIcon::     INCBIN "gfx/icons/pikachu.2bpp"
LudicoloIcon::   INCBIN "gfx/icons/pikachu.2bpp"
SeedotIcon::     INCBIN "gfx/icons/pikachu.2bpp"
NuzleafIcon::    INCBIN "gfx/icons/pikachu.2bpp"
ShiftryIcon::    INCBIN "gfx/icons/pikachu.2bpp"
TaillowIcon::    INCBIN "gfx/icons/pikachu.2bpp"
SwellowIcon::    INCBIN "gfx/icons/pikachu.2bpp"
WingullIcon::    INCBIN "gfx/icons/pikachu.2bpp"
PelipperIcon::   INCBIN "gfx/icons/pikachu.2bpp"
RaltsIcon::      INCBIN "gfx/icons/pikachu.2bpp"
KirliaIcon::     INCBIN "gfx/icons/pikachu.2bpp"
GardevoirIcon::  INCBIN "gfx/icons/pikachu.2bpp"
SurskitIcon::    INCBIN "gfx/icons/pikachu.2bpp"
MasquerainIcon:: INCBIN "gfx/icons/pikachu.2bpp"
ShroomishIcon::  INCBIN "gfx/icons/pikachu.2bpp"
BreloomIcon::    INCBIN "gfx/icons/pikachu.2bpp"
SlakothIcon::    INCBIN "gfx/icons/pikachu.2bpp"
VigorothIcon::   INCBIN "gfx/icons/pikachu.2bpp"
SlakingIcon::    INCBIN "gfx/icons/pikachu.2bpp"
NincadaIcon::    INCBIN "gfx/icons/pikachu.2bpp"
NinjaskIcon::    INCBIN "gfx/icons/pikachu.2bpp"
ShedinjaIcon::   INCBIN "gfx/icons/pikachu.2bpp"
WhismurIcon::    INCBIN "gfx/icons/pikachu.2bpp"
LoudredIcon::    INCBIN "gfx/icons/pikachu.2bpp"
ExploudIcon::    INCBIN "gfx/icons/pikachu.2bpp"
MakuhitaIcon::   INCBIN "gfx/icons/pikachu.2bpp"
HariyamaIcon::   INCBIN "gfx/icons/pikachu.2bpp"
AzurillIcon::    INCBIN "gfx/icons/pikachu.2bpp"
NosepassIcon::   INCBIN "gfx/icons/pikachu.2bpp"
SkittyIcon::     INCBIN "gfx/icons/pikachu.2bpp"
DelcattyIcon::   INCBIN "gfx/icons/pikachu.2bpp"
SableyeIcon::    INCBIN "gfx/icons/pikachu.2bpp"
MawileIcon::     INCBIN "gfx/icons/pikachu.2bpp"
AronIcon::       INCBIN "gfx/icons/pikachu.2bpp"
LaironIcon::     INCBIN "gfx/icons/pikachu.2bpp"
AggronIcon::     INCBIN "gfx/icons/pikachu.2bpp"
MedititeIcon::   INCBIN "gfx/icons/pikachu.2bpp"
MedichamIcon::   INCBIN "gfx/icons/pikachu.2bpp"
ElectrikeIcon::  INCBIN "gfx/icons/pikachu.2bpp"
ManectricIcon::  INCBIN "gfx/icons/pikachu.2bpp"
PlusleIcon::     INCBIN "gfx/icons/pikachu.2bpp"
MinunIcon::      INCBIN "gfx/icons/pikachu.2bpp"
VolbeatIcon::    INCBIN "gfx/icons/pikachu.2bpp"
IllumiseIcon::   INCBIN "gfx/icons/pikachu.2bpp"
RoseliaIcon::    INCBIN "gfx/icons/pikachu.2bpp"
GulpinIcon::     INCBIN "gfx/icons/pikachu.2bpp"
SwalotIcon::     INCBIN "gfx/icons/pikachu.2bpp"
CarvanhaIcon::   INCBIN "gfx/icons/pikachu.2bpp"
SharpedoIcon::   INCBIN "gfx/icons/pikachu.2bpp"
WailmerIcon::    INCBIN "gfx/icons/pikachu.2bpp"
WailordIcon::    INCBIN "gfx/icons/pikachu.2bpp"
NumelIcon::      INCBIN "gfx/icons/pikachu.2bpp"
CameruptIcon::   INCBIN "gfx/icons/pikachu.2bpp"
TorkoalIcon::    INCBIN "gfx/icons/pikachu.2bpp"
SpoinkIcon::     INCBIN "gfx/icons/pikachu.2bpp"
GrumpigIcon::    INCBIN "gfx/icons/pikachu.2bpp"
SpindaIcon::     INCBIN "gfx/icons/pikachu.2bpp"
TrapinchIcon::   INCBIN "gfx/icons/pikachu.2bpp"
VibravaIcon::    INCBIN "gfx/icons/pikachu.2bpp"
FlygonIcon::     INCBIN "gfx/icons/pikachu.2bpp"
CacneaIcon::     INCBIN "gfx/icons/pikachu.2bpp"
CacturneIcon::   INCBIN "gfx/icons/pikachu.2bpp"
SwabluIcon::     INCBIN "gfx/icons/pikachu.2bpp"
AltariaIcon::    INCBIN "gfx/icons/pikachu.2bpp"
ZangooseIcon::   INCBIN "gfx/icons/pikachu.2bpp"
SeviperIcon::    INCBIN "gfx/icons/pikachu.2bpp"
LunatoneIcon::   INCBIN "gfx/icons/pikachu.2bpp"
SolrockIcon::    INCBIN "gfx/icons/pikachu.2bpp"
;reddit mons
