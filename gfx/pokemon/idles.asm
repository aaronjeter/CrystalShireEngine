...
Tauros2AnimationIdle:     INCLUDE "gfx/pokemon/tauros2/anim_idle.asm"
Swinub2AnimationIdle:     INCLUDE "gfx/pokemon/swinub2/anim_idle.asm"
Piloswine2AnimationIdle:  INCLUDE "gfx/pokemon/piloswine2/anim_idle.asm"
