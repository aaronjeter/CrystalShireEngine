...
Tauros2Bitmasks:     INCLUDE "gfx/pokemon/tauros2/bitmask.asm"
Swinub2Bitmasks:     INCLUDE "gfx/pokemon/swinub2/bitmask.asm"
Piloswine2Bitmasks:  INCLUDE "gfx/pokemon/piloswine2/bitmask.asm"
