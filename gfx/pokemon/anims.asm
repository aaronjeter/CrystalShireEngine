...
Tauros2Animation:     INCLUDE "gfx/pokemon/tauros2/anim.asm"
Swinub2Animation:     INCLUDE "gfx/pokemon/swinub2/anim.asm"
Piloswine2Animation:  INCLUDE "gfx/pokemon/piloswine2/anim.asm"
