...
FalknerGroup: ;Gym Leader
	...
	db "Falkner@", TRAINERTYPE_NICKNAME | TRAINERTYPE_DVS | TRAINERTYPE_ITEM | TRAINERTYPE_MOVES
	dbwbbbw 8, LUVDISC, "BoB@", HP_MAX_FIRE, PERFECT_DV, NO_ITEM
		dw DRILL_PECK, TOXIC, COSMIC_POWER, REST
	dbwbbbw 8, XATU, "Frank@", HP_MAX_WATER, PERFECT_DV, NO_ITEM
		dw PSYCHIC_M, CONFUSE_RAY, RAZOR_WIND, MUD_SLAP
	dbwbbbw 8, GLISCOR, "Ted@", HP_MAX_GHOST, PERFECT_DV, QUICK_CLAW
		dw FISSURE, MUD_SLAP, SLASH, PURSUIT
	dbwbbbw 8, PELIPPER, "@", HP_MAX_GRASS, PERFECT_DV, LEFTOVERS
		dw HYDRO_PUMP, PROTECT, HURRICANE, RECOVER
	dbwbbbw 8, DELIBIRD, "Fry@", HP_MAX_GHOST, PERFECT_DV, NO_ITEM
		dw BLIZZARD, MUD_SLAP, SKY_ATTACK, CONFUSE_RAY
	dbwbbbw 11, NOCTOWL2, "867530@", HP_MAX_GRASS, PERFECT_DV, TWISTEDSPOON
		dw WILLOWISP, MUD_SLAP, PSYCHIC_M, MOONBLAST
	db -1 ; end

	next_list_item ; FALKNER (4) ;World Cup Falkner
	db "Falkner@", TRAINERTYPE_ITEM_MOVES
	dbww 10, ARTICUNO, NO_ITEM
		dw DRILL_PECK, HURRICANE, BLIZZARD, PSYBEAM
	dbww 10, ZAPDOS, NO_ITEM
		dw THUNDERBOLT, DRILL_PECK, RAZOR_WIND, JUMP_KICK
	dbww 10, MOLTRES, QUICK_CLAW
		dw SKY_ATTACK, MUD_SLAP, FIRE_BLAST, PURSUIT
	dbww 9, PELIPPER, LEFTOVERS
		dw HYDRO_PUMP, PROTECT, HURRICANE, RECOVER
	dbww 9, DELIBIRD, NO_ITEM
		dw BLIZZARD, MUD_SLAP, SKY_ATTACK, CONFUSE_RAY
...
GentlemanGroup:
	...
	db "GregoryY@", TRAINERTYPE_NORMAL
	db 7
	dw PIKACHU
	db 7
	dw MAREEP
...
WallaceGroup:
	...
	dw WAILORD
	dw BITTER_BERRY
	dw WATER_SPOUT, AMNESIA, REST, BODY_SLAM
	db 11
	dw MILOTIC
	dw LEFTOVERS
...
ExplorerGroup:
	...
	dbw 12, GENGAR
		dw HEX, WILLOWISP, TOXIC, DARK_PULSE	
	dbw 12, VICTREEBEL
		dw STUN_SPORE, SLUDGE_BOMB, NATURE_POWER, FRENZY_PLANT
	dbw 13, CLEFABLE
