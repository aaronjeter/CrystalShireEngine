...
WhitneyGroupHard:
	...
	dw CLEFABLE
	dw LEFTOVERS
	dw SWIFT, CALM_MIND, PSYCHIC_M, METEOR_MASH	
	db 12
	dw WIGGLYTUFF
	dw LEFTOVERS
	dw WILLOWISP, COSMIC_POWER, DIZZY_PUNCH, REST	
...
MortyGroupHard:
	...
	dw AMAROWAK
	dw THICK_CLUB
	dw EARTHQUAKE, HEADBUTT, SHADOW_CLAW, BLAST_BURN	
	db 12
	dw WYRDEER
	dw NO_ITEM
...
PryceGroupHard:
	...
	dw WALREIN
	dw LEFTOVERS
	dw HYDRO_PUMP, ICY_WIND, ICE_BEAM, REST	
	db 12
	dw JYNX
	dw FOCUS_BAND
	...
	dw WEAVILE
	dw FOCUS_BAND
	dw ICE_PUNCH, ICICLE_CRASH, MACH_PUNCH, PURSUIT
	db 12
	dw MAMOSWINE
	dw QUICK_CLAW
	...
	dw REGICE
	dw FOCUS_BAND
	dw BLIZZARD, CALM_MIND, FLASHCANNON, RECOVER
	db -1 ; end
...
WillGroupHard:
	...
	dw METAGROSS
	dw TWISTEDSPOON
	dw ZEN_HEADBUTT, METEOR_MASH, MACH_PUNCH, EARTHQUAKE
	db -1 ; end
...
ChampionGroupHard:
	...
	dw RAYQUAZA
	dw FOCUS_BAND
	dw SKY_ATTACK, DRAGON_DANCE, EXTREMESPEED, EARTHQUAKE
	db -1 ; end
...
LtSurgeGroupHard:
	...
	db 12
	dw HELECTRODE
	dw GIGA_DRAIN, THUNDERBOLT, EXPLOSION, THUNDER_WAVE
	db 12
	dw ARAICHU
	dw DIG, SURF, VOLT_TACKLE, SWIFT	
	db 12
...
JanineGroupHard:
	...
	db 12
	dw WEEZING
	dw SLUDGE_BOMB, FIRE_BLAST, TOXIC, WILLOWISP
	db 12
	dw AMUK
	dw SLUDGE_BOMB, RECOVER, CRUNCH, TOXIC
	db 12
	dw SWALOT
	dw SLUDGE_BOMB, MUD_SHOT, REST, TOXIC
	db 12
	dw ARIADOS
	dw MEGAHORN, GIGA_DRAIN, STRING_SHOT, NIGHT_SHADE
	db 12
	dw NIDOKING
	dw FISSURE, MEGAHORN, BULK_UP, SLUDGE_BOMB
	db 15
	dw NIDOQUEEN
	dw EARTHQUAKE, MEGAHORN, BULK_UP, SLUDGE_BOMB
	db -1 ; end
...
SabrinaGroupHard:
	...
	db 12
	dw JYNX
	dw ICY_WIND, PSYCHIC_M, BLIZZARD, SHADOW_BALL
	db 12
	dw CHIMECHO
	dw ICY_WIND, PSYCHIC_M, SHADOW_BALL, DESTINY_BOND
	db 12
	dw MR__MIME
	dw BARRIER, REFLECT, BATON_PASS, PSYCHIC_M
	db 12
...
BlaineGroupHard:
	...
	db 12
	dw SOLROCK
	dw ROCK_SLIDE, FIRE_BLAST, EXPLOSION, WILLOWISP
	db 12
	dw MAGCARGO
	dw ROCK_SLIDE, FIRE_BLAST, FISSURE, CURSE
	db 12
	...
	db 15
	dw MOLTRES
	dw SKY_ATTACK, PURSUIT, WILLOWISP, FIRE_BLAST
	db -1 ; end
