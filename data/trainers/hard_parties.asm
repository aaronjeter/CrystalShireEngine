...
PryceGroupHard:
	...
	dbww 10, DELIBIRD, FOCUS_BAND
		dw BLIZZARD, RAZOR_WIND, ICY_WIND, SPIKES
	dbww 10, WALREIN, LEFTOVERS
		dw SURF, HAIL, BLIZZARD, REST	
	dbww 10, JYNX, FOCUS_BAND
		dw HAIL, PSYCHIC_M, BLIZZARD, LOVELY_KISS
	dbww 10, WEAVILE, FOCUS_BAND
		dw ICICLE_CRASH, SLASH, MACH_PUNCH, PURSUIT
	dbww 12, MAMOSWINE, QUICK_CLAW
		dw EARTHQUAKE, ICICLE_CRASH, BULK_UP, BODY_SLAM
	dbww 12, GLALIEX, NEVERMELTICE
...
ExplorerGroupHard:
	...
	dbww 7, CLEFAIRY, POLKADOT_BOW
		dw DRAININGKISS, WILLOWISP, BUBBLEBEAM, MAGICAL_LEAF
	dbww 7, HAUNTER, BERRY
		dw NIGHT_SHADE, HEX, VENOSHOCK, HYPNOSIS
	dbww 7, WEEPINBELL, BERRY
		dw STUN_SPORE, LEECH_SEED, VINE_WHIP, GROWTH
	dbww 8, FEAROW, BERRY
		dw WING_ATTACK, FAINT_ATTACK, MIRROR_MOVE, SHARPEN
	dbww 10, WARTORTLE, MYSTIC_WATER
		dw BUBBLEBEAM, RAPID_SPIN, ICE_FANG, RAIN_DANCE
	db -1 ; end

	next_list_item ; WC_GREEN (?) World Cup Green
	db "Green@", TRAINERTYPE_ITEM_MOVES
	dbww 12, KANGASKHAN, PINK_BOW
		dw DIZZY_PUNCH, CRUNCH, DOUBLE_EDGE, EARTHQUAKE
	dbww 12, CLEFABLE, QUICK_CLAW
		dw MOONBLAST, WILLOWISP, REST, CALM_MIND	
	dbww 12, ANINETALES, NEVERMELTICE
		dw BLIZZARD, ICY_WIND, MOONBLAST, RECOVER
	dbww 13, GENGARX, SCOPE_LENS
		dw HEX, VENOSHOCK, TOXIC, DESTINY_BOND
	dbww 13, VICTREEBELX, LEFTOVERS
		dw TOXIC, VENOSHOCK, EARTHQUAKE, GIGA_DRAIN
	dbww 15, BLASTOISEX, LEFTOVERS
		dw RAIN_DANCE, HYDRO_PUMP, BLIZZARD, REST
	db -1 ; end
