...
MapGroup_Hoenn:
	table_width MAP_LENGTH
	map LittlerootTown, TILESET_HOENN, TOWN, LANDMARK_LITTLEROOT, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map BirchsLab, TILESET_LAB, INDOOR, LANDMARK_LITTLEROOT, MUSIC_POKEMON_TALK, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OldaleTown, TILESET_HOENN, TOWN, LANDMARK_OLDALE, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map OldalePokecenter, TILESET_POKECOM_CENTER, INDOOR, LANDMARK_OLDALE, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OldaleMart, TILESET_MART, INDOOR, LANDMARK_OLDALE, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OldaleHouse1, TILESET_HOUSE, INDOOR, LANDMARK_OLDALE, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OldaleHouse2, TILESET_HOUSE, INDOOR, LANDMARK_OLDALE, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_MORN, FISHGROUP_SHORE
	map PetalburgCity, TILESET_HOENN, TOWN, LANDMARK_PETALBURG, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map PetalburgGym, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_PETALBURG, MUSIC_CHERRYGROVE_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map PetalburgPokecenter, TILESET_POKECOM_CENTER, INDOOR, LANDMARK_PETALBURG, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PetalburgMart, TILESET_MART, INDOOR, LANDMARK_PETALBURG, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PetalburgHouse1, TILESET_HOUSE, INDOOR, LANDMARK_PETALBURG, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PetalburgHouse2, TILESET_HOUSE, INDOOR, LANDMARK_PETALBURG, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_MORN, FISHGROUP_SHORE
	map RustboroCity, TILESET_HOENN, TOWN, LANDMARK_RUSTBORO, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map RustboroGym, TILESET_CHAMPIONS_ROOM, INDOOR, LANDMARK_RUSTBORO, MUSIC_CHERRYGROVE_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RustboroPokecenter, TILESET_POKECOM_CENTER, INDOOR, LANDMARK_RUSTBORO, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RustboroMart, TILESET_MART, INDOOR, LANDMARK_RUSTBORO, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RustboroCutterHouse, TILESET_HOUSE, INDOOR, LANDMARK_RUSTBORO, MUSIC_VIOLET_CITY, FALSE, PALETTE_EVE, FISHGROUP_SHORE
	map RustboroTradeHouse, TILESET_HOUSE, INDOOR, LANDMARK_RUSTBORO, MUSIC_VIOLET_CITY, FALSE, PALETTE_EVE, FISHGROUP_SHORE
	map VerdanturfTown, TILESET_HOENN, TOWN, LANDMARK_VERDANTURF, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map VerdanturfPokecenter, TILESET_POKECOM_CENTER, INDOOR, LANDMARK_VERDANTURF, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map VerdanturfMart, TILESET_MART, INDOOR, LANDMARK_VERDANTURF, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map VerdanturfRockSmashHouse, TILESET_HOUSE, INDOOR, LANDMARK_VERDANTURF, MUSIC_VIOLET_CITY, FALSE, PALETTE_EVE, FISHGROUP_SHORE
	map VerdanturfTradeHouse, TILESET_HOUSE, INDOOR, LANDMARK_VERDANTURF, MUSIC_VIOLET_CITY, FALSE, PALETTE_EVE, FISHGROUP_SHORE
	map MauvilleCity, TILESET_HOENN, TOWN, LANDMARK_MAUVILLE, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map MauvilleGym, TILESET_GAME_CORNER, INDOOR, LANDMARK_MAUVILLE, MUSIC_CHERRYGROVE_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map MauvillePokecenter, TILESET_POKECOM_CENTER, INDOOR, LANDMARK_MAUVILLE, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map MauvilleMart, TILESET_MART, INDOOR, LANDMARK_MAUVILLE, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map MauvilleTradeHouse, TILESET_HOUSE, INDOOR, LANDMARK_MAUVILLE, MUSIC_VIOLET_CITY, FALSE, PALETTE_EVE, FISHGROUP_SHORE
	map MauvilleBikeShop, TILESET_CHAMPIONS_ROOM, INDOOR, LANDMARK_MAUVILLE, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SlateportCity, TILESET_HOENN, TOWN, LANDMARK_SLATEPORT, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SlateportPokecenter, TILESET_POKECOM_CENTER, INDOOR, LANDMARK_SLATEPORT, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SlateportMart, TILESET_MART, INDOOR, LANDMARK_SLATEPORT, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SlateportHarbor, TILESET_PORT, INDOOR, LANDMARK_SLATEPORT, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SlateportTradeHouse, TILESET_HOUSE, INDOOR, LANDMARK_SLATEPORT, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map DewfordTown, TILESET_HOENN, TOWN, LANDMARK_DEWFORD, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map DewfordGym, TILESET_FACILITY, INDOOR, LANDMARK_DEWFORD, MUSIC_CHERRYGROVE_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map DewfordPokecenter, TILESET_POKECOM_CENTER, INDOOR, LANDMARK_DEWFORD, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map DewfordBrineyHouse, TILESET_TRADITIONAL_HOUSE, ROUTE, LANDMARK_DEWFORD, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_MORN, FISHGROUP_SHORE
	map LavaridgeTown, TILESET_HOENN, TOWN, LANDMARK_LAVARIDGE, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map LavaridgePokecenter, TILESET_POKECOM_CENTER, INDOOR, LANDMARK_LAVARIDGE, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map LavaridgeMart, TILESET_MART, INDOOR, LANDMARK_LAVARIDGE, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map LavaridgeGym, TILESET_LIGHTHOUSE, INDOOR, LANDMARK_LAVARIDGE, MUSIC_CHERRYGROVE_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map FortreeCity, TILESET_HOENN, TOWN, LANDMARK_FORTREE, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map FortreePokecenter, TILESET_POKECOM_CENTER, INDOOR, LANDMARK_FORTREE, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FortreeMart, TILESET_MART, INDOOR, LANDMARK_FORTREE, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FortreeGym, TILESET_LIGHTHOUSE, INDOOR, LANDMARK_FORTREE, MUSIC_CHERRYGROVE_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map FortreeTradeHouse, TILESET_HOUSE, TOWN, LANDMARK_FORTREE, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route101, TILESET_HOENN, ROUTE, LANDMARK_ROUTE_101, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route102, TILESET_HOENN, ROUTE, LANDMARK_ROUTE_102, LANDMARK_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route103, TILESET_HOENN, ROUTE, LANDMARK_ROUTE_103, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route104, TILESET_HOENN, ROUTE, LANDMARK_ROUTE_104, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map MrBrineyHouse, TILESET_TRADITIONAL_HOUSE, ROUTE, LANDMARK_ROUTE_104, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_MORN, FISHGROUP_SHORE
	map Route104FlowerHouse, TILESET_HOUSE, ROUTE, LANDMARK_ROUTE_104, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_EVE, FISHGROUP_SHORE
	map Route105, TILESET_HOENN, ROUTE, LANDMARK_ROUTE_105, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route108, TILESET_HOENN, ROUTE, LANDMARK_ROUTE_108, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route109, TILESET_HOENN, ROUTE, LANDMARK_ROUTE_109, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route110, TILESET_HOENN, ROUTE, LANDMARK_ROUTE_110, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route111, TILESET_HOENN, ROUTE, LANDMARK_ROUTE_111, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map LavaridgeDesert, TILESET_CAVE, CAVE, LANDMARK_LAVARIDGE_DESERT, MUSIC_BURNED_TOWER, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route112, TILESET_HOENN, ROUTE, LANDMARK_ROUTE_112, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map FieryPath, TILESET_CAVE, CAVE, LANDMARK_FIERY_PATH, MUSIC_BURNED_TOWER, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map Route113, TILESET_HOENN, ROUTE, LANDMARK_ROUTE_113, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route116, TILESET_HOENN, ROUTE, LANDMARK_ROUTE_116, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route117, TILESET_HOENN, ROUTE, LANDMARK_ROUTE_117, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map TestRoom, TILESET_LAB, INDOOR, LANDMARK_DRAGONS_DEN, MUSIC_DRAGONS_DEN, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map FallarborTown, TILESET_HOENN, TOWN, LANDMARK_FALLARBOR, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map FallarborPokecenter, TILESET_POKECOM_CENTER, INDOOR, LANDMARK_FALLARBOR, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FallarborMart, TILESET_MART, INDOOR, LANDMARK_FALLARBOR, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FallarborReminderHouse, TILESET_HOUSE, TOWN, LANDMARK_FALLARBOR, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route114, TILESET_HOENN, ROUTE, LANDMARK_ROUTE_114, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map LanetteHouse, TILESET_LAB, ROUTE, LANDMARK_ROUTE_114, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_MORN, FISHGROUP_SHORE
	map Route115, TILESET_HOENN, ROUTE, LANDMARK_ROUTE_115, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map MeteorFalls, TILESET_CAVE, CAVE, LANDMARK_METEOR_FALLS, MUSIC_BURNED_TOWER, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map Route118, TILESET_HOENN, ROUTE, LANDMARK_ROUTE_118, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map NewMauville, TILESET_FACILITY, CAVE, LANDMARK_NEW_MAUVILLE, MUSIC_UNION_CAVE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map NewMauvilleBasement, TILESET_FACILITY, INDOOR, LANDMARK_NEW_MAUVILLE, MUSIC_ROCKET_HIDEOUT, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map MauvilleGameCorner, TILESET_GAME_CORNER, INDOOR, LANDMARK_MAUVILLE, MUSIC_GAME_CORNER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route119South, TILESET_HOENN, ROUTE, LANDMARK_ROUTE_119, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route119FisherHouse, TILESET_HOUSE, TOWN, LANDMARK_ROUTE_119, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route119North, TILESET_HOENN, ROUTE, LANDMARK_ROUTE_119, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE	
	map Route120, TILESET_HOENN, ROUTE, LANDMARK_ROUTE_120, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE	
	map Route121, TILESET_HOENN, ROUTE, LANDMARK_ROUTE_121, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE	
	map Route122, TILESET_HOENN, ROUTE, LANDMARK_ROUTE_122, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE	
	map Route123, TILESET_HOENN, ROUTE, LANDMARK_ROUTE_123, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE	
	map LilycoveCity, TILESET_HOENN, TOWN, LANDMARK_LILYCOVE, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map LilycovePokecenter, TILESET_POKECOM_CENTER, INDOOR, LANDMARK_LILYCOVE, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map LilycoveTradeHouse, TILESET_HOUSE, TOWN, LANDMARK_LILYCOVE, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map LilycovePaintHouse, TILESET_HOUSE, TOWN, LANDMARK_LILYCOVE, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map LilycoveHarbor, TILESET_PORT, INDOOR, LANDMARK_LILYCOVE, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map MtPyre, TILESET_HOENN, ROUTE, LANDMARK_MT_PYRE, MUSIC_BURNED_TOWER, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map MossdeepCity, TILESET_HOENN, TOWN, LANDMARK_MOSSDEEP, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map MossdeepPokecenter, TILESET_POKECOM_CENTER, INDOOR, LANDMARK_MOSSDEEP, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map MossdeepMart, TILESET_MART, INDOOR, LANDMARK_MOSSDEEP, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map MossdeepGym, TILESET_TRAIN_STATION, TOWN, LANDMARK_MOSSDEEP, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SootopolisCity, TILESET_HOENN, TOWN, LANDMARK_SOOTOPOLIS, MUSIC_AZALEA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SootopolisPokecenter, TILESET_POKECOM_CENTER, INDOOR, LANDMARK_SOOTOPOLIS, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SootopolisMart, TILESET_MART, INDOOR, LANDMARK_SOOTOPOLIS, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SootopolisGym, TILESET_ELITE_FOUR_ROOM, INDOOR, LANDMARK_SOOTOPOLIS, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map SootopolisFisherHouse, TILESET_HOUSE, TOWN, LANDMARK_SOOTOPOLIS, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map EvergrandeCity, TILESET_HOENN, TOWN, LANDMARK_EVERGRANDE, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map EvergrandePokecenter, TILESET_POKECOM_CENTER, INDOOR, LANDMARK_EVERGRANDE, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map EvergrandeDungeon, TILESET_CAVE, CAVE, LANDMARK_EVERGRANDE, MUSIC_BURNED_TOWER, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map EvergrandeDungeonB1F, TILESET_CAVE, CAVE, LANDMARK_EVERGRANDE, MUSIC_BURNED_TOWER, TRUE, PALETTE_NITE, FISHGROUP_SHORE		
	map EvergrandeDungeonB2F, TILESET_CAVE, CAVE, LANDMARK_EVERGRANDE, MUSIC_BURNED_TOWER, TRUE, PALETTE_NITE, FISHGROUP_SHORE		
	map HoennPokeleague, TILESET_POKECOM_CENTER, INDOOR, LANDMARK_EVERGRANDE, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SidneysRoom, TILESET_ELITE_FOUR_ROOM, INDOOR, LANDMARK_EVERGRANDE, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map PhoebesRoom, TILESET_ELITE_FOUR_ROOM, INDOOR, LANDMARK_EVERGRANDE, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map GlaciasRoom, TILESET_ELITE_FOUR_ROOM, INDOOR, LANDMARK_EVERGRANDE, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map DrakesRoom, TILESET_ELITE_FOUR_ROOM, INDOOR, LANDMARK_EVERGRANDE, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map StevensRoom, TILESET_CHAMPIONS_ROOM, INDOOR, LANDMARK_EVERGRANDE, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map BattleResort, TILESET_HOENN, TOWN, LANDMARK_EVERGRANDE, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map BattleResortPokecenter, TILESET_POKECOM_CENTER, INDOOR, LANDMARK_EVERGRANDE, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map BattleResortMart, TILESET_MART, INDOOR, LANDMARK_EVERGRANDE, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FancyRocks, TILESET_MART, INDOOR, LANDMARK_EVERGRANDE, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TreetopTrial, TILESET_HOENN, CAVE, LANDMARK_EVERGRANDE, MUSIC_UNION_CAVE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map AshenGauntlet, TILESET_HOENN, CAVE, LANDMARK_EVERGRANDE, MUSIC_UNION_CAVE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map WorldCupLobby, TILESET_POKECOM_CENTER, INDOOR, LANDMARK_EVERGRANDE, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map BattleResortHarbor, TILESET_PORT, INDOOR, LANDMARK_EVERGRANDE, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map WCQualifier1, TILESET_POKECOM_CENTER, INDOOR, LANDMARK_EVERGRANDE, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map WCQualifier2, TILESET_POKECOM_CENTER, INDOOR, LANDMARK_EVERGRANDE, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map WCQualifier3, TILESET_POKECOM_CENTER, INDOOR, LANDMARK_EVERGRANDE, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map WCChallengerLobby, TILESET_POKECOM_CENTER, INDOOR, LANDMARK_EVERGRANDE, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map WCRoundOne, TILESET_ELITE_FOUR_ROOM, INDOOR, LANDMARK_EVERGRANDE, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map WCRoundTwo, TILESET_ELITE_FOUR_ROOM, INDOOR, LANDMARK_EVERGRANDE, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map WCRoundThree, TILESET_ELITE_FOUR_ROOM, INDOOR, LANDMARK_EVERGRANDE, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map WCRoundFour, TILESET_CHAMPIONS_ROOM, INDOOR, LANDMARK_EVERGRANDE, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map WCFinals, TILESET_ICE_PATH, INDOOR, LANDMARK_EVERGRANDE, MUSIC_NEW_BARK_TOWN, TRUE, PALETTE_DAY, FISHGROUP_SHORE
