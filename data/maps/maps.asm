...
MapGroup_Dungeons:
	...
	map PetalburgWoods, TILESET_FOREST, CAVE, LANDMARK_ROUTE_2, MUSIC_UNION_CAVE, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map RusturfTunnel, TILESET_CAVE, CAVE, LANDMARK_ROUTE_2, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map GraniteCaveB1F, TILESET_CAVE, CAVE, LANDMARK_ROUTE_2, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map GraniteCaveB2F, TILESET_CAVE, CAVE, LANDMARK_ROUTE_2, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map GraniteCaveB3F, TILESET_CAVE, CAVE, LANDMARK_ROUTE_2, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map RegiceLair, TILESET_ICE_PATH, CAVE, LANDMARK_ICE_PATH, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
	map DesertRuin1F, TILESET_CAVE, CAVE, LANDMARK_CHERRYGROVE_CITY, MUSIC_BURNED_TOWER, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map DesertRuinB1F, TILESET_CAVE, CAVE, LANDMARK_CHERRYGROVE_CITY, MUSIC_BURNED_TOWER, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map RegirockLair, TILESET_RUINS_OF_ALPH, DUNGEON, LANDMARK_CHERRYGROVE_CITY, MUSIC_BURNED_TOWER, FALSE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Hoenn:
	table_width MAP_LENGTH
	map LittlerootTown, TILESET_HOENN, TOWN, LANDMARK_CHERRYGROVE_CITY, LANDMARK_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map BirchsLab, TILESET_LAB, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_POKEMON_TALK, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OldaleTown, TILESET_HOENN, TOWN, LANDMARK_CHERRYGROVE_CITY, LANDMARK_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map OldalePokecenter, TILESET_POKECOM_CENTER, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OldaleMart, TILESET_MART, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PetalburgCity, TILESET_HOENN, TOWN, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map PetalburgGym, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map PetalburgPokecenter, TILESET_POKECOM_CENTER, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PetalburgMart, TILESET_MART, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PetalburgHouse1, TILESET_HOUSE, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PetalburgHouse2, TILESET_HOUSE, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_MORN, FISHGROUP_SHORE
	map RustboroCity, TILESET_HOENN, TOWN, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map RustboroGym, TILESET_CHAMPIONS_ROOM, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RustboroPokecenter, TILESET_POKECOM_CENTER, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RustboroMart, TILESET_MART, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RustboroCutterHouse, TILESET_HOUSE, INDOOR, LANDMARK_OLIVINE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_EVE, FISHGROUP_SHORE
	map VerdanturfTown, TILESET_HOENN, TOWN, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map VerdanturfPokecenter, TILESET_POKECOM_CENTER, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map VerdanturfMart, TILESET_MART, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map VerdanturfRockSmashHouse, TILESET_HOUSE, INDOOR, LANDMARK_OLIVINE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_EVE, FISHGROUP_SHORE
	map MauvilleCity, TILESET_HOENN, TOWN, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map MauvilleGym, TILESET_GAME_CORNER, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map MauvillePokecenter, TILESET_POKECOM_CENTER, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map MauvilleMart, TILESET_MART, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SlateportCity, TILESET_HOENN, TOWN, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SlateportPokecenter, TILESET_POKECOM_CENTER, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SlateportMart, TILESET_MART, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SlateportHarbor, TILESET_PORT, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map DewfordTown, TILESET_HOENN, TOWN, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map DewfordGym, TILESET_FACILITY, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map DewfordPokecenter, TILESET_POKECOM_CENTER, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map LavaridgeTown, TILESET_HOENN, TOWN, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map LavaridgePokecenter, TILESET_POKECOM_CENTER, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map LavaridgeMart, TILESET_MART, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map LavaridgeGym, TILESET_LIGHTHOUSE, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map FortreeCity, TILESET_HOENN, TOWN, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map FortreePokecenter, TILESET_POKECOM_CENTER, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FortreeMart, TILESET_MART, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FortreeGym, TILESET_LIGHTHOUSE, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map Route101, TILESET_HOENN, ROUTE, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route102, TILESET_HOENN, ROUTE, LANDMARK_CHERRYGROVE_CITY, LANDMARK_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route103, TILESET_HOENN, ROUTE, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route104, TILESET_HOENN, ROUTE, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map MrBrineyHouse, TILESET_TRADITIONAL_HOUSE, ROUTE, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_MORN, FISHGROUP_SHORE
	map Route104FlowerHouse, TILESET_HOUSE, ROUTE, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_EVE, FISHGROUP_SHORE
	map Route105, TILESET_HOENN, ROUTE, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route108, TILESET_HOENN, ROUTE, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route109, TILESET_HOENN, ROUTE, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route110, TILESET_HOENN, ROUTE, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route111, TILESET_HOENN, ROUTE, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map LavaridgeDesert, TILESET_HOENN, ROUTE, LANDMARK_CHERRYGROVE_CITY, MUSIC_BURNED_TOWER, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route112, TILESET_HOENN, ROUTE, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map FieryPath, TILESET_CAVE, CAVE, LANDMARK_CHERRYGROVE_CITY, MUSIC_BURNED_TOWER, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map Route113, TILESET_HOENN, ROUTE, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route116, TILESET_HOENN, ROUTE, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route117, TILESET_HOENN, ROUTE, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map TestRoom, TILESET_LAB, INDOOR, LANDMARK_DRAGONS_DEN, MUSIC_DRAGONS_DEN, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map FallarborTown, TILESET_HOENN, TOWN, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map FallarborPokecenter, TILESET_POKECOM_CENTER, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FallarborMart, TILESET_MART, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route114, TILESET_HOENN, ROUTE, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route115, TILESET_HOENN, ROUTE, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map MeteorFalls, TILESET_CAVE, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_BURNED_TOWER, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map Route118, TILESET_HOENN, ROUTE, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map NewMauville, TILESET_FACILITY, INDOOR, LANDMARK_RUINS_OF_ALPH, MUSIC_UNION_CAVE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route119South, TILESET_HOENN, ROUTE, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route119North, TILESET_HOENN, ROUTE, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE	
	map Route120, TILESET_HOENN, ROUTE, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE	
	map Route121, TILESET_HOENN, ROUTE, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE	
	map Route122, TILESET_HOENN, ROUTE, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE	
	map Route123, TILESET_HOENN, ROUTE, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE	
	map LilycoveCity, TILESET_HOENN, TOWN, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map LilycovePokecenter, TILESET_POKECOM_CENTER, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
