...
MapGroup_Dungeons:
	...
	map ArticunoLair, TILESET_ICE_PATH, CAVE, LANDMARK_ICE_PATH, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
	map MoltresLair, TILESET_JOHTO, ROUTE, LANDMARK_MT_MORTAR, MUSIC_ECRUTEAK_CITY, TRUE, PALETTE_AUTO, FISHGROUP_DRATINI
	map ViridianForest, TILESET_FOREST, CAVE, LANDMARK_ROUTE_2, MUSIC_UNION_CAVE, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map PetalburgWoods, TILESET_FOREST, CAVE, LANDMARK_PETALBURG_WOODS, MUSIC_UNION_CAVE, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map RusturfTunnel, TILESET_CAVE, CAVE, LANDMARK_RUSTURF_TUNNEL, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	...
	map GraniteCaveB3F, TILESET_CAVE, CAVE, LANDMARK_GRANITE_CAVE, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map RegiceLair, TILESET_ICE_PATH, CAVE, LANDMARK_ICE_PATH, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
	map RegirockLair, TILESET_CAVE, CAVE, LANDMARK_LAVARIDGE_DESERT, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
	map RegisteelLair, TILESET_CAVE, CAVE, LANDMARK_ROUTE_120, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
	...
	map DesertShrine, TILESET_RUINS_OF_ALPH, DUNGEON, LANDMARK_LAVARIDGE_DESERT, MUSIC_BURNED_TOWER, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	...
	map SafariHouseSouth, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_EVOLUTION, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariHouseEast, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_EVOLUTION, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariHouseNorth, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_EVOLUTION, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariHouseWest, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_EVOLUTION, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariHouseSecret, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_EVOLUTION, TRUE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cerulean:
	...
	map CeruleanBikeShop, TILESET_CHAMPIONS_ROOM, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cianwood:
	...
	map JohtoGames, TILESET_JOHTO, ROUTE, LANDMARK_BATTLE_TOWER, MUSIC_BATTLE_TOWER_THEME, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
