...
MapGroup_Hoenn:
	...
	map LavaridgeDesert, TILESET_HOENN, ROUTE, LANDMARK_LAVARIDGE_DESERT, MUSIC_BURNED_TOWER, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map MeteorFalls, TILESET_CAVE, INDOOR, LANDMARK_METEOR_FALLS, MUSIC_BURNED_TOWER, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map Route118, TILESET_HOENN, ROUTE, LANDMARK_ROUTE_118, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map NewMauville, TILESET_FACILITY, INDOOR, LANDMARK_NEW_MAUVILLE, MUSIC_UNION_CAVE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
