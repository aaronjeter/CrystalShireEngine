...
MovesGen1:
	...
	move EFFECT_DEFENSE_DOWN_HIT,   50, FIGHTING,       90, 25,  50      ;KARATE_CHOP
	move EFFECT_MULTI_HIT,          20, FAIRY,         100, 15,   0      ;DOUBLESLAP
	move EFFECT_MULTI_HIT,          20, NORMAL,        100, 15,   0      ;COMET_PUNCH
	move EFFECT_NORMAL_HIT,         80, NORMAL,         90, 20,   0      ;MEGA_PUNCH
	move EFFECT_PAY_DAY,            65, NORMAL,        100, 20,   0      ;PAY_DAY
	move EFFECT_BURN_HIT,           70, FIRE,          100, 15,  25      ;FIRE_PUNCH
	move EFFECT_FREEZE_HIT,         70, ICE,           100, 15,  25      ;ICE_PUNCH
	move EFFECT_PARALYZE_HIT,       70, ELECTRIC,      100, 15,  25      ;THUNDERPUNCH
	move EFFECT_NORMAL_HIT,         40, NORMAL,        100, 35,   0      ;SCRATCH
	move EFFECT_NORMAL_HIT,         90, STEEL,         100, 15,   0      ;VICEGRIP
	move EFFECT_DEFENSE_DOWN_HIT,  120, STEEL,          80, 10, 100      ;GUILLOTINE
	move EFFECT_DEFENSE_DOWN_HIT,   55, NORMAL,        100, 15, 100      ;RAZOR_WIND
	move EFFECT_ATTACK_UP_2,         0, NORMAL,        100, 30,   0      ;SWORDS_DANCE
	move EFFECT_DEFENSE_DOWN_HIT,   55, STEEL,         100, 15, 100      ;CUT
	move EFFECT_GUST,               40, FLYING,        100, 35,   0      ;GUST
	move EFFECT_NORMAL_HIT,         65, FLYING,        100, 35,   0      ;WING_ATTACK
	move EFFECT_FORCE_SWITCH,        0, NORMAL,        100, 20,   0      ;WHIRLWIND
	move EFFECT_FLY,               100, FLYING,         95, 15,   0      ;FLY
	move EFFECT_TRAP_TARGET,        35, NORMAL,        100, 20,   0      ;BIND
	move EFFECT_NORMAL_HIT,         80, NORMAL,         85, 20,   0      ;SLAM
	move EFFECT_NORMAL_HIT,         40, GRASS,         100, 20,   0      ;VINE_WHIP
	...
	move EFFECT_JUMP_KICK,          85, FIGHTING,       90, 25,   0      ;JUMP_KICK
	move EFFECT_FLINCH_HIT,         60, FIGHTING,       85, 15,  30      ;ROLLING_KICK
	move EFFECT_ACCURACY_DOWN_HIT,  35, GROUND,        100, 15,  25      ;SAND_ATTACK
	...
	move EFFECT_FLINCH_HIT,         35, NORMAL,         95, 35,  25      ;TACKLE
	move EFFECT_PARALYZE_HIT,       85, NORMAL,        100, 15,  30      ;BODY_SLAM
	move EFFECT_TRAP_TARGET,        35, GRASS,         100, 20,   0      ;WRAP
	move EFFECT_RECOIL_HIT,        100, NORMAL,         90, 20,   0      ;TAKE_DOWN
	move EFFECT_RAMPAGE,           100, NORMAL,        100, 20,   0      ;THRASH
	move EFFECT_RECOIL_HIT,        120, NORMAL,        100, 15,   0      ;DOUBLE_EDGE
	move EFFECT_DEFENSE_DOWN_HIT,   30, NORMAL,        100, 30, 100      ;TAIL_WHIP
	move EFFECT_POISON_HIT,         35, POISON,        100, 35,  30      ;POISON_STING
	move EFFECT_POISON_MULTI_HIT,   30, BUG,           100, 20,  20      ;TWINEEDLE
	move EFFECT_MULTI_HIT,          30, BUG,            90, 20,   0      ;PIN_MISSILE
	move EFFECT_DEFENSE_DOWN_2,      0, NORMAL,        100, 30,   0      ;LEER
	move EFFECT_FLINCH_HIT,         40, DARK,          100, 25,  10      ;BITE
	move EFFECT_ATTACK_DOWN_2,       0, NORMAL,        100, 40,   0      ;GROWL
	move EFFECT_FORCE_SWITCH,        0, NORMAL,        100, 20,   0      ;ROAR
	move EFFECT_SLEEP,               0, NORMAL,         60, 15,   0      ;SING
	move EFFECT_CONFUSE,             0, NORMAL,         80, 20,   0      ;SUPERSONIC
	move EFFECT_STATIC_DAMAGE,      20, NORMAL,         90, 20,   0      ;SONICBOOM
	move EFFECT_DISABLE,             0, NORMAL,         55, 20,   0      ;DISABLE
	move EFFECT_DEFENSE_DOWN_HIT,   30, POISON,        100, 30, 100      ;ACID
	move EFFECT_BURN_HIT,           35, FIRE,          100, 25,  20      ;EMBER
	move EFFECT_BURN_HIT,           90, FIRE,          100, 15,   5      ;FLAMETHROWER
	move EFFECT_MIST,                0, ICE,           100, 30,   0      ;MIST
	move EFFECT_NORMAL_HIT,         40, WATER,         100, 25,   0      ;WATER_GUN
	move EFFECT_NORMAL_HIT,        115, WATER,          90, 10,   0      ;HYDRO_PUMP
	move EFFECT_SPEED_UP_HIT,       60, WATER,         100, 15, 100      ;SURF
	move EFFECT_FREEZE_HIT,         90, ICE,           100, 10,   5      ;ICE_BEAM
	move EFFECT_FREEZE_HIT,        110, ICE,            90, 10,  10      ;BLIZZARD
	move EFFECT_CONFUSE_HIT,        65, PSYCHIC_TYPE,  100, 20,  10      ;PSYBEAM
	move EFFECT_SPEED_DOWN_HIT,     60, WATER,         100, 20,  50      ;BUBBLEBEAM
	move EFFECT_ATTACK_DOWN_HIT,    60, ICE,           100, 20,  50      ;AURORA_BEAM
	move EFFECT_HYPER_BEAM,        180, NORMAL,        100, 10,   0      ;HYPER_BEAM
	move EFFECT_NORMAL_HIT,         40, FLYING,        100, 35,   0      ;PECK
	move EFFECT_NORMAL_HIT,         90, FLYING,        100, 20,   0      ;DRILL_PECK
	move EFFECT_RECOIL_HIT,        100, FIGHTING,      100, 25,   0      ;SUBMISSION
	move EFFECT_FLINCH_HIT,         40, FIGHTING,       90, 20,  10      ;LOW_KICK
	move EFFECT_COUNTER,             1, FIGHTING,      100, 20,   0      ;COUNTER
	move EFFECT_LEVEL_DAMAGE,        1, FIGHTING,      100, 20,   0      ;SEISMIC_TOSS
	move EFFECT_ATTACK_UP_HIT,      55, ROCK,          100, 15, 100      ;STRENGTH
	move EFFECT_LEECH_HIT,          35, GRASS,         100, 20,   0      ;ABSORB
	move EFFECT_LEECH_HIT,          55, GRASS,         100, 10,   0      ;MEGA_DRAIN
	move EFFECT_LEECH_SEED,          0, GRASS,         100, 10,   0      ;LEECH_SEED
	move EFFECT_SP_ATK_UP,           0, NORMAL,        100, 40,   0      ;GROWTH
	move EFFECT_SP_DEF_DOWN_HIT,    55, GRASS,         100, 25, 100      ;RAZOR_LEAF
	move EFFECT_SOLARBEAM,         120, GRASS,         100, 10,   0      ;SOLARBEAM
	move EFFECT_POISON,              0, POISON,        100, 35,   0      ;POISONPOWDER
	move EFFECT_PARALYZE,            0, GRASS,         100, 30,   0      ;STUN_SPORE
	move EFFECT_SLEEP,               0, GRASS,          75, 15,   0      ;SLEEP_POWDER
	move EFFECT_RAMPAGE,           100, GRASS,         100, 20,   0      ;PETAL_DANCE
	move EFFECT_SPEED_DOWN_HIT,     35, BUG,           100, 40, 100      ;STRING_SHOT
	move EFFECT_STATIC_DAMAGE,      40, DRAGON,        100, 10,   0      ;DRAGON_RAGE
	move EFFECT_TRAP_TARGET,        60, FIRE,          100, 15,   0      ;FIRE_SPIN
	move EFFECT_PARALYZE_HIT,       35, ELECTRIC,      100, 30,  10      ;THUNDERSHOCK
	move EFFECT_PARALYZE_HIT,       90, ELECTRIC,      100, 15,   5      ;THUNDERBOLT
	move EFFECT_PARALYZE,            0, ELECTRIC,      100, 20,   0      ;THUNDER_WAVE
	move EFFECT_THUNDER,           120, ELECTRIC,       80, 10,  50      ;THUNDER
	move EFFECT_NORMAL_HIT,         55, ROCK,           90, 15,   0      ;ROCK_THROW
	move EFFECT_EARTHQUAKE,         95, GROUND,        100, 10,   0      ;EARTHQUAKE
	move EFFECT_NORMAL_HIT,        130, GROUND,         80, 10,   0      ;FISSURE
	move EFFECT_FLY,                80, GROUND,        100, 10,   0      ;DIG
	move EFFECT_TOXIC,               0, POISON,         85, 10,   0      ;TOXIC
	move EFFECT_CONFUSE_HIT,        40, PSYCHIC_TYPE,  100, 25,  25      ;CONFUSION
	move EFFECT_SP_DEF_DOWN_HIT,    85, PSYCHIC_TYPE,  100, 10,  25      ;PSYCHIC_TYPE_M
	move EFFECT_SLEEP,               0, PSYCHIC_TYPE,   60, 20,   0      ;HYPNOSIS
	move EFFECT_SP_ATK_UP_2,         0, PSYCHIC_TYPE,  100, 40,   0      ;MEDITATE
	...
	move EFFECT_NORMAL_HIT,        100, GRASS,          90, 10,   0      ;EGG_BOMB
	move EFFECT_PARALYZE_HIT,       30, GHOST,         100, 30,  25      ;LICK
	move EFFECT_POISON_HIT,         45, POISON,         70, 20,  50      ;SMOG
	move EFFECT_POISON_HIT,         65, POISON,        100, 20,  25      ;SLUDGE
	move EFFECT_FLINCH_HIT,         55, GROUND,         85, 20,  20      ;BONE_CLUB
	move EFFECT_SP_DEF_DOWN_HIT,   110, FIRE,           90, 10, 100      ;FIRE_BLAST
	move EFFECT_SP_ATK_UP_HIT,      55, WATER,         100, 15, 100      ;WATERFALL
	move EFFECT_TRAP_TARGET,        35, WATER,         100, 10,   0      ;CLAMP
	move EFFECT_ALWAYS_HIT,         80, FAIRY,         100, 20,   0      ;SWIFT
	move EFFECT_SKULL_BASH,        120, STEEL,         100, 15,   0      ;SKULL_BASH
	move EFFECT_MULTI_HIT,          30, STEEL,         100, 15,   0      ;SPIKE_CANNON
	move EFFECT_SPEED_DOWN_HIT,     35, NORMAL,        100, 35,  50      ;CONSTRICT
	...
	move EFFECT_JUMP_KICK,         100, FIGHTING,       90, 20,   0      ;HI_JUMP_KICK
	move EFFECT_PARALYZE,            0, NORMAL,        100, 30,   0      ;GLARE
	move EFFECT_DREAM_EATER,       120, PSYCHIC_TYPE,  100, 15,   0      ;DREAM_EATER
	move EFFECT_POISON,              0, POISON,         55, 40,   0      ;POISON_GAS
	move EFFECT_MULTI_HIT,          25, NORMAL,         85, 20,   0      ;BARRAGE
	move EFFECT_LEECH_HIT,          35, BUG,           100, 15,   0      ;LEECH_LIFE
	move EFFECT_SLEEP,               0, NORMAL,         75, 10,   0      ;LOVELY_KISS
	move EFFECT_NORMAL_HIT,        110, FLYING,         90,  5,   0      ;SKY_ATTACK
	move EFFECT_TRANSFORM,           0, NORMAL,        100, 10,   0      ;TRANSFORM
	move EFFECT_SPEED_DOWN_HIT,     35, WATER,         100, 30,  50      ;BUBBLE
	move EFFECT_CONFUSE_HIT,        75, FAIRY,         100, 10,  25      ;DIZZY_PUNCH
	move EFFECT_SLEEP,               0, GRASS,          85, 15,   0      ;SPORE
	move EFFECT_ACCURACY_DOWN_2,     0, NORMAL,         70, 20,   0      ;FLASH
	move EFFECT_LEVEL_DAMAGE,        1, PSYCHIC_TYPE,  100, 15,   0      ;PSYWAVE
	move EFFECT_SPLASH,              0, NORMAL,        100, 40,   0      ;SPLASH
	move EFFECT_DEFENSE_UP_2,        0, POISON,        100, 40,   0      ;ACID_ARMOR
	move EFFECT_NORMAL_HIT,        100, WATER,         100, 10,   0      ;CRABHAMMER
	move EFFECT_SELFDESTRUCT,      250, NORMAL,        100,  5,   0      ;EXPLOSION
	move EFFECT_MULTI_HIT,          18, NORMAL,         90, 15,   0      ;FURY_SWIPES
	move EFFECT_DOUBLE_HIT,         50, GROUND,         90, 10,   0      ;BONEMERANG
	move EFFECT_HEAL,                0, PSYCHIC_TYPE,  100, 10,   0      ;REST
	move EFFECT_FLINCH_HIT,         75, ROCK,          100, 10,  10      ;ROCK_SLIDE
	...
	move EFFECT_TRI_ATTACK,         85, NORMAL,        100, 10,  25      ;TRI_ATTACK
	move EFFECT_SUPER_FANG,          1, NORMAL,         90, 10,   0      ;SUPER_FANG
	move EFFECT_NORMAL_HIT,         90, NORMAL,        100, 20,   0      ;SLASH
...
MovesGen2:
	...
	move EFFECT_TRIPLE_KICK,        15, FIGHTING,       90, 10,   0      ;TRIPLE_KICK
	move EFFECT_THIEF,              80, DARK,          100, 10, 100      ;THIEF
	...
	move EFFECT_FLAME_WHEEL,        90, FIRE,          100, 25,  10      ;FLAME_WHEEL
	...
	move EFFECT_FREEZE_HIT,         35, ICE,           100, 25,  25      ;POWDER_SNOW
	move EFFECT_PROTECT,             0, NORMAL,        100, 10,   0      ;PROTECT
	move EFFECT_PRIORITY_HIT,       50, FIGHTING,      100, 30,   0      ;MACH_PUNCH
	move EFFECT_SPEED_DOWN_2,        0, NORMAL,         90, 10,   0      ;SCARY_FACE
	move EFFECT_ALWAYS_HIT,         60, DARK,          100, 20,   0      ;FAINT_ATTACK
	move EFFECT_CONFUSE,             0, NORMAL,        100, 10,   0      ;SWEET_KISS
	move EFFECT_BELLY_DRUM,          0, NORMAL,        100, 10,   0      ;BELLY_DRUM
	move EFFECT_POISON_HIT,         90, POISON,        100, 10,  10      ;SLUDGE_BOMB
	move EFFECT_ACCURACY_DOWN_HIT,  40, GROUND,        100, 10, 100      ;MUD_SLAP
	move EFFECT_ACCURACY_DOWN_HIT,  70, WATER,         100, 10,  50      ;OCTAZOOKA
	move EFFECT_SPIKES,              0, GROUND,        100, 20,   0      ;SPIKES
	move EFFECT_PARALYZE_HIT,      150, ELECTRIC,       65,  5, 100      ;ZAP_CANNON
	...
	move EFFECT_FREEZE,              0, ICE,           100, 15, 100      ;ICY_WIND
	...
	move EFFECT_RAMPAGE,           100, DRAGON,        100, 15,   0      ;OUTRAGE
	...
	move EFFECT_FALSE_SWIPE,        60, NORMAL,        100, 40,   0      ;FALSE_SWIPE
	move EFFECT_SWAGGER,             0, NORMAL,         90, 15, 100      ;SWAGGER
	move EFFECT_HEAL,                0, NORMAL,        100, 10,   0      ;MILK_DRINK
	move EFFECT_PARALYZE_HIT,       65, ELECTRIC,       90, 20,  25      ;SPARK
	move EFFECT_DEFENSE_DOWN_HIT,   55, BUG,           100, 20, 100      ;FURY_CUTTER
	move EFFECT_DEFENSE_UP_HIT,     60, STEEL,          90, 25,  50      ;STEEL_WING
	...
	move EFFECT_CONFUSE_HIT,       100, FIGHTING,       75,  5, 100      ;DYNAMICPUNCH
	move EFFECT_NORMAL_HIT,        120, BUG,            85, 10,   0      ;MEGAHORN
	move EFFECT_PARALYZE_HIT,       80, DRAGON,        100, 20,  25      ;DRAGONBREATH
	move EFFECT_BATON_PASS,          0, NORMAL,        100, 40,   0      ;BATON_PASS
	move EFFECT_ENCORE,              0, NORMAL,        100,  5,   0      ;ENCORE
	move EFFECT_PURSUIT,            80, DARK,          100, 20,   0      ;PURSUIT
	move EFFECT_RAPID_SPIN,         60, NORMAL,        100, 40,   0      ;RAPID_SPIN
	move EFFECT_EVASION_DOWN,        0, NORMAL,        100, 20,   0      ;SWEET_SCENT
	move EFFECT_DEFENSE_DOWN_HIT,  100, STEEL,          90, 15,  30      ;IRON_TAIL
	move EFFECT_ATTACK_UP_HIT,      25, STEEL,          95, 35, 100      ;METAL_CLAW
	move EFFECT_ALWAYS_HIT,         85, FIGHTING,      100, 10,   0      ;VITAL_THROW
	...
	move EFFECT_DEFENSE_DOWN_HIT,   80, DARK,          100, 15,  25      ;CRUNCH
	...
	move EFFECT_SP_DEF_DOWN_HIT,    80, GHOST,         100, 15,  25      ;SHADOW_BALL
	move EFFECT_FUTURE_SIGHT,      120, PSYCHIC_TYPE,  100, 15,   0      ;FUTURE_SIGHT
	move EFFECT_DEFENSE_DOWN_HIT,   55, FIGHTING,      100, 15, 100      ;ROCK_SMASH
	move EFFECT_TRAP_TARGET,        75, WATER,         100, 15,   0      ;WHIRLPOOL
	move EFFECT_BEAT_UP,            10, DARK,          100, 10,   0      ;BEAT_UP
	move EFFECT_BURN,                0, FIRE,          100, 15,   0      ;WILLOWISP
	move EFFECT_ACCURACY_DOWN_HIT,  35, FAIRY,         100, 25,  25      ;PIXIE_DUST
	move EFFECT_FLINCH_HIT,         65, FAIRY,         100, 20,  20      ;FAE_VOICE
.IndirectEnd::
