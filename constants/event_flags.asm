...
; Kanto hidden items
	...
	;Hoenn Route Trainers

	const EVENT_BEAT_ROUTE102_CALVIN
	const EVENT_BEAT_ROUTE102_ALLEN
	const EVENT_BEAT_ROUTE102_RICK
	const EVENT_BEAT_ROUTE102_TIANA

	const EVENT_BEAT_ROUTE103_DAISY
	const EVENT_BEAT_ROUTE103_AMYLIV
	const EVENT_BEAT_ROUTE103_MIGUEL
	const EVENT_BEAT_ROUTE103_ANDREW
	const EVENT_BEAT_ROUTE103_RHETT
	const EVENT_BEAT_ROUTE103_MARCOS

	const EVENT_BEAT_ROUTE104_BILLY
	const EVENT_BEAT_ROUTE104_DARIAN
	const EVENT_BEAT_ROUTE104_CINDY
	const EVENT_BEAT_ROUTE104_WINSTON
	const EVENT_BEAT_ROUTE104_HALEY
	const EVENT_BEAT_ROUTE104_GINAMIA
	const EVENT_BEAT_ROUTE104_IVAN

	const EVENT_BEAT_PETALBURGWOODS_LYLE
	const EVENT_BEAT_PETALBURGWOODS_JAMES	

	const EVENT_BEAT_ROUTE105_IMANI
	const EVENT_BEAT_ROUTE105_LUIS
	const EVENT_BEAT_ROUTE105_FOSTER
	const EVENT_BEAT_ROUTE105_ANDRES
	const EVENT_BEAT_ROUTE105_JOSUE
	const EVENT_BEAT_ROUTE105_NED
	const EVENT_BEAT_ROUTE105_ELLIOT

	const EVENT_BEAT_ROUTE108_DENISE
	const EVENT_BEAT_ROUTE108_TONY
	const EVENT_BEAT_ROUTE108_LISARIA
	const EVENT_BEAT_ROUTE108_DARRIN
	const EVENT_BEAT_ROUTE108_BETH
	const EVENT_BEAT_ROUTE108_CAMRON

	const EVENT_BEAT_ROUTE109_HUEY
	const EVENT_BEAT_ROUTE109_EDMOND
	const EVENT_BEAT_ROUTE109_HAILEY
	const EVENT_BEAT_ROUTE109_RICKY
	const EVENT_BEAT_ROUTE109_LOLA
	const EVENT_BEAT_ROUTE109_CHANDLER

	const EVENT_BEAT_ROUTE110_ISABEL
	const EVENT_BEAT_ROUTE110_KALEB
	const EVENT_BEAT_ROUTE110_TIMMY
	const EVENT_BEAT_ROUTE110_EDWIN
	const EVENT_BEAT_ROUTE110_JOSEPH
	const EVENT_BEAT_ROUTE110_EDWARD
	const EVENT_BEAT_ROUTE110_DALE

	const EVENT_BEAT_ROUTE111_TYRON
	const EVENT_BEAT_ROUTE111_CELINA
	const EVENT_BEAT_ROUTE111_BIANCA
	const EVENT_BEAT_ROUTE111_HAYDEN
	const EVENT_BEAT_ROUTE111_GABBY
	const EVENT_BEAT_ROUTE111_IRENE
	const EVENT_BEAT_ROUTE111_TRAVIS

	const EVENT_BEAT_ROUTE112_TRENT
	const EVENT_BEAT_ROUTE112_BRICE
	const EVENT_BEAT_ROUTE112_CAROL
	const EVENT_BEAT_ROUTE112_LARRY
	const EVENT_BEAT_ROUTE112_BRYANT
	const EVENT_BEAT_ROUTE112_SHAYLA

	const EVENT_BEAT_ROUTE113_LAO
	const EVENT_BEAT_ROUTE113_DILLON
	const EVENT_BEAT_ROUTE113_COBY
	const EVENT_BEAT_ROUTE113_WYATT
	const EVENT_BEAT_ROUTE113_MADELINE
	const EVENT_BEAT_ROUTE113_SOPHIE
	const EVENT_BEAT_ROUTE113_JAYLEN
	const EVENT_BEAT_ROUTE113_LUNG
	const EVENT_BEAT_ROUTE113_LAWRENCE
	const EVENT_BEAT_ROUTE113_TORITIA

	const EVENT_BEAT_ROUTE114_STEVE
	const EVENT_BEAT_ROUTE114_NOLAN
	const EVENT_BEAT_ROUTE114_KAI
	const EVENT_BEAT_ROUTE114_CLAUDE
	const EVENT_BEAT_ROUTE114_LUCAS
	const EVENT_BEAT_ROUTE114_LENNY
	const EVENT_BEAT_ROUTE114_BERNIE
	const EVENT_BEAT_ROUTE114_CHARLOTTE
	const EVENT_BEAT_ROUTE114_NANCY
	const EVENT_BEAT_ROUTE114_ANGELINA
	const EVENT_BEAT_ROUTE114_SHANE

	const EVENT_BEAT_DESERT_HEIDI
	const EVENT_BEAT_DESERT_BECKY
	const EVENT_BEAT_DESERT_CELIA
	const EVENT_BEAT_DESERT_BEAU
	const EVENT_BEAT_DESERT_DREW
	const EVENT_BEAT_DESERT_BRANDEN
	const EVENT_BEAT_DESERT_DUSTY	
	const EVENT_BEAT_DESERT_BRYAN	

	const EVENT_BEAT_ROUTE116_JOEY
	const EVENT_BEAT_ROUTE116_JOHNSON
	const EVENT_BEAT_ROUTE116_KAREN
	const EVENT_BEAT_ROUTE116_JANICE
	const EVENT_BEAT_ROUTE116_JOSE
	const EVENT_BEAT_ROUTE116_CLARK
	const EVENT_BEAT_ROUTE116_DEVAN

	const EVENT_BEAT_ROUTE117_DYLAN
	const EVENT_BEAT_ROUTE117_ANNAMEG
	const EVENT_BEAT_ROUTE117_ISAAC
	const EVENT_BEAT_ROUTE117_MARIA
	const EVENT_BEAT_ROUTE117_DEREK
	const EVENT_BEAT_ROUTE117_BRANDI
	const EVENT_BEAT_ROUTE117_MELINA
	const EVENT_BEAT_ROUTE117_AISHA
	const EVENT_BEAT_ROUTE117_LYDIA

	const EVENT_BEAT_ROUTE118_DALE
	const EVENT_BEAT_ROUTE118_CHESTER
	const EVENT_BEAT_ROUTE118_PERRY
	const EVENT_BEAT_ROUTE118_SALLY
	const EVENT_BEAT_ROUTE118_ANNIE
	const EVENT_BEAT_ROUTE118_BARNY

	const EVENT_BEAT_ROUTE119_PHIL
	const EVENT_BEAT_ROUTE119_HUGH
	const EVENT_BEAT_ROUTE119_DONALD
	const EVENT_BEAT_ROUTE119_TAYLOR
	const EVENT_BEAT_ROUTE119_BRENT
	const EVENT_BEAT_ROUTE119_KENT
	const EVENT_BEAT_ROUTE119_GREG
	const EVENT_BEAT_ROUTE119_DOUG
	const EVENT_BEAT_ROUTE119_CHRIS
	const EVENT_BEAT_ROUTE119_FABIAN
	const EVENT_BEAT_ROUTE119_DAYTON
	const EVENT_BEAT_ROUTE119_JACKSON
	const EVENT_BEAT_ROUTE119_TAKASHI
	const EVENT_BEAT_ROUTE119_YASU
	const EVENT_BEAT_ROUTE119_HIDEO
	const EVENT_BEAT_ROUTE119_CATHERINE
	const EVENT_BEAT_ROUTE119_RACHEL
	const EVENT_BEAT_ROUTE119_DANI

	const EVENT_BEAT_ROUTE120_ROBERT
	const EVENT_BEAT_ROUTE120_COLIN
	const EVENT_BEAT_ROUTE120_LEONEL
	const EVENT_BEAT_ROUTE120_JENNIFER
	const EVENT_BEAT_ROUTE120_CLARISSA
	const EVENT_BEAT_ROUTE120_ANGELICA
	const EVENT_BEAT_ROUTE120_JEFFREY
	const EVENT_BEAT_ROUTE120_CALLIE
	const EVENT_BEAT_ROUTE120_RILEY
	const EVENT_BEAT_ROUTE120_LORENZO
	const EVENT_BEAT_ROUTE120_KEIGO
	const EVENT_BEAT_ROUTE120_JENNA	
	const EVENT_BEAT_ROUTE120_CHIP
	const EVENT_BEAT_ROUTE120_DALE


	const EVENT_STARTED_RADIO_ROCKETS
	const EVENT_BEAT_DESERT_SHRINE_UNOWN

	const EVENT_BEAT_TREETOP_ROUND1
	const EVENT_BEAT_TREETOP_ROUND2
	const EVENT_BEAT_TREETOP_ROUND3
	const EVENT_BEAT_TREETOP_ROUND4
	const EVENT_BEAT_TREETOP_ROUND5
	const EVENT_BEAT_TREETOP_ROUND6
	const EVENT_BEAT_TREETOP_ROUND7

	const EVENT_BEAT_ASH_ROUND1
	const EVENT_BEAT_ASH_ROUND2
	const EVENT_BEAT_ASH_ROUND3
	const EVENT_BEAT_ASH_ROUND4
	const EVENT_BEAT_ASH_ROUND5
	const EVENT_BEAT_ASH_ROUND6
	const EVENT_BEAT_ASH_ROUND7

	const EVENT_BEAT_RUSTTURF_ROCKET1
	const EVENT_BEAT_RUSTTURF_ROCKET2
	const EVENT_BEAT_RUSTTURF_ROCKET3

	const EVENT_BEAT_MAUVILLE_ROCKET1
	const EVENT_BEAT_MAUVILLE_ROCKET2
	const EVENT_BEAT_MAUVILLE_ROCKET3
	const EVENT_BEAT_MAUVILLE_ROCKET4
	const EVENT_BEAT_MAUVILLE_ROCKETF1
	const EVENT_BEAT_MAUVILLE_ROCKETF2
	const EVENT_BEAT_MAUVILLE_ROCKETF3
	const EVENT_BEAT_MAUVILLE_SCIENTIST1
	const EVENT_BEAT_MAUVILLE_SCIENTIST2
	const EVENT_BEAT_MAUVILLE_SCIENTIST3
	const EVENT_BEAT_MAUVILLE_SCIENTIST4

	const EVENT_BEAT_MAUVILLE_ROCKETS

	const EVENT_BEAT_PYRE_ROCKETS

	const EVENT_BEAT_ROUTE121_ROCKET1
	const EVENT_BEAT_ROUTE121_ROCKET2
	const EVENT_BEAT_ROUTE121_ROCKETF1
	const EVENT_BEAT_ROUTE121_ROCKETF2

	const EVENT_BEAT_PYRE_ROCKET1
	const EVENT_BEAT_PYRE_ROCKET2
	const EVENT_BEAT_PYRE_ROCKET3
	const EVENT_BEAT_PYRE_ROCKET4
	const EVENT_BEAT_PYRE_ROCKETF1
	const EVENT_BEAT_PYRE_ROCKETF2
...
; Djinn events (formerly phone events)
	...
	const EVENT_GOT_FOSSIL_HELIX_MTMOON
	const EVENT_GOT_FOSSIL_HELIX_WHIRL_ISLAND
	const EVENT_GOT_FOSSIL_DOME_MTMOON
	...
	const EVENT_GOT_FOSSIL_ROOT_DESERT
	const EVENT_GOT_FOSSIL_CLAW_METEOR_EAST
	const EVENT_GOT_FOSSIL_CLAW_DESERT
	const EVENT_GOT_FOSSIL_URSA_ILEX_EAST
	const EVENT_GOT_FOSSIL_URSA_RUSTBORO 
	const EVENT_GOT_FOSSIL_FIN_PEWTER_MUSEUM
	...
	const EVENT_GOT_DESERT_OLD_AMBER 
	const_skip ; unused
	const_skip ; unused
	const_skip ; unused
	const_skip ; unused
...
; More Crystal-exclusive events in Johto
	...
	const EVENT_DEFEATED_CELEBI_GUARDIAN_VENOMOTH
	const EVENT_DEFEATED_CELEBI_GUARDIAN_HYPNO
	const EVENT_DEFEATED_CELEBI_GUARDIAN_SUNFLORA
	...
	const EVENT_GOT_HOENN_BLACKGLASSES ;Route 115
	const EVENT_GOT_HOENN_METAL_COAT
	const EVENT_GOT_HOENN_POLKADOT_BOW ;Rustboro City
...
; Swimmer F
	...
	const EVENT_BEAT_SWIMMERF_LISA_UNUSED
	const EVENT_BEAT_SWIMMERF_JILL_UNUSED
	const EVENT_BEAT_SWIMMERF_MARY_UNUSED
	const EVENT_BEAT_SWIMMERF_KATIE_UNUSED
	const EVENT_BEAT_SWIMMERF_DAWN
	const EVENT_BEAT_SWIMMERF_TARA_UNUSED
	const EVENT_BEAT_SWIMMERF_NICOLE
	const EVENT_BEAT_SWIMMERF_LORI
	const EVENT_BEAT_SWIMMERF_JODY_UNUSED
...
; Bird Keeper
	...
	const EVENT_BEAT_BIRD_KEEPER_JOSE_UNUSED
	const EVENT_BEAT_BIRD_KEEPER_PETER
	const EVENT_BEAT_BIRD_KEEPER_JOSE2 ;for whatever reason, JOSE2is the one actually used
	const EVENT_BEAT_BIRD_KEEPER_PERRY
	const EVENT_BEAT_BIRD_KEEPER_BRET
	const EVENT_BEAT_BIRD_KEEPER_JOSE3_UNUSED
	const EVENT_BEAT_BIRD_KEEPER_VANCE2_UNUSED
	const EVENT_BEAT_BIRD_KEEPER_VANCE3_UNUSED
; Boarder
...
; Firebreather
	...
	const EVENT_BEAT_FIREBREATHER_DICK_UNUSED
	const EVENT_BEAT_FIREBREATHER_NED_UNUSED
...
; Schoolboy
	...
	const EVENT_BEAT_SCHOOLBOY_JACK2_UNUSED
	const EVENT_BEAT_SCHOOLBOY_JACK3_UNUSED
	const EVENT_BEAT_SCHOOLBOY_ALAN2_UNUSED
	const EVENT_BEAT_SCHOOLBOY_ALAN3_UNUSED
	const EVENT_BEAT_SCHOOLBOY_CHAD2_UNUSED
	const EVENT_BEAT_SCHOOLBOY_CHAD3_UNUSED
; Picnicker
	...
	const EVENT_BEAT_PICNICKER_GINA2_UNUSED
	const EVENT_BEAT_PICNICKER_ERIN
	const EVENT_BEAT_PICNICKER_LIZ2_UNUSED
	const EVENT_BEAT_PICNICKER_LIZ3_UNUSED
	const EVENT_BEAT_PICNICKER_HEIDI
	const EVENT_BEAT_PICNICKER_EDNA
	const EVENT_BEAT_PICNICKER_GINA3_UNUSED
	const EVENT_BEAT_PICNICKER_TIFFANY2_UNUSED
	const EVENT_BEAT_PICNICKER_TIFFANY3_UNUSED
	const EVENT_BEAT_PICNICKER_ERIN2_UNUSED
	const EVENT_BEAT_PICNICKER_TANYA
	const EVENT_BEAT_PICNICKER_TIFFANY
	const EVENT_BEAT_PICNICKER_ERIN3_UNUSED
; Guitarist
...
; Gentleman
	...
	const EVENT_BEAT_GENTLEMAN_VIRGIL_UNUSED
...
; GruntM
	...
	const EVENT_BEAT_ROCKET_GRUNTM_12_UNUSED
	...
	const EVENT_BEAT_ROCKET_GRUNTM_22_UNUSED
	const EVENT_BEAT_ROCKET_GRUNTM_23_UNUSED
	const EVENT_BEAT_ROCKET_GRUNTM_24
	const EVENT_BEAT_ROCKET_GRUNTM_25
	const EVENT_BEAT_ROCKET_GRUNTM_26_UNUSED
	const EVENT_BEAT_ROCKET_GRUNTM_27_UNUSED
	const EVENT_BEAT_ROCKET_GRUNTM_28
	const EVENT_BEAT_ROCKET_GRUNTM_29
	const EVENT_BEAT_ROCKET_GRUNTM_30_UNUSED
...
; CooltrainerM
	...
	const EVENT_BEAT_COOLTRAINERM_ERICK_UNUSED
	const EVENT_BEAT_COOLTRAINERM_ANDY_UNUSED
	const EVENT_BEAT_COOLTRAINERM_TYLER_UNUSED
	const EVENT_BEAT_COOLTRAINERM_SEAN
	const EVENT_BEAT_COOLTRAINERM_KEVIN
	const EVENT_BEAT_COOLTRAINERM_STEVE_UNUSED
...
; Super Nerd
	...
	const EVENT_BEAT_SUPER_NERD_GREGG_UNUSED
	const EVENT_BEAT_SUPER_NERD_JAY_UNUSED
	const EVENT_BEAY_SUPER_NERD_DAVE_UNUSED
...
; SwimmerM
	...
	const EVENT_BEAT_SWIMMERM_HAL_UNUSED
	const EVENT_BEAT_SWIMMERM_PATON_UNUSED
	const EVENT_BEAT_SWIMMERM_DARYL_UNUSED
	const EVENT_BEAT_SWIMMERM_WALTER_UNUSED
	const EVENT_BEAT_SWIMMERM_TONY_UNUSED
	...
	const EVENT_BEAT_SWIMMERM_JAMES_UNUSED
	const EVENT_BEAT_SWIMMERM_LEWIS_UNUSED
...
;Hoenn Trainer Flags
	...
	;Rustboro Gym
	const EVENT_BEAT_RUSTBORO_JOSH
	const EVENT_BEAT_RUSTBORO_TOMMY
	const EVENT_BEAT_RUSTBORO_MARC

	;Dewford Gym
	const EVENT_BEAT_DEWFORD_LAURA
	const EVENT_BEAT_DEWFORD_LILITH
	const EVENT_BEAT_DEWFORD_BRENDEN
	const EVENT_BEAT_DEWFORD_TAKAO
	const EVENT_BEAT_DEWFORD_CRISTIAN
	const EVENT_BEAT_DEWFORD_JOCELYN

	;Mauville Gym
	const EVENT_BEAT_MAUVILLE_VIVIAN
	const EVENT_BEAT_MAUVILLE_KIRK
	const EVENT_BEAT_MAUVILLE_BEN
	const EVENT_BEAT_MAUVILLE_ANGELO
	const EVENT_BEAT_MAUVILLE_SHAWN
	...
	;Lavaridge Gym
	const EVENT_BEAT_LAVARIDGE_JEFF
	const EVENT_BEAT_LAVARIDGE_JACE
	const EVENT_BEAT_LAVARIDGE_ELI
	const EVENT_BEAT_LAVARIDGE_COLE
	const EVENT_BEAT_LAVARIDGE_GERALD
	const EVENT_BEAT_LAVARIDGE_AXLE
	const EVENT_BEAT_LAVARIDGE_KEEGAN
	const EVENT_BEAT_LAVARIDGE_DANIELLE

	;Fortree Gym
	const EVENT_BEAT_FORTREE_HUMBERT
	const EVENT_BEAT_FORTREE_JARED
	const EVENT_BEAT_FORTREE_ASHLEY
	const EVENT_BEAT_FORTREE_FLINT
	const EVENT_BEAT_FORTREE_EDWARDO
	const EVENT_BEAT_FORTREE_DARIUS

	;Mossdeep Gym
	const EVENT_BEAT_MOSSDEEP_CLIFF
	const EVENT_BEAT_MOSSDEEP_NATE
	const EVENT_BEAT_MOSSDEEP_PRESTON
	const EVENT_BEAT_MOSSDEEP_BLAKE
	const EVENT_BEAT_MOSSDEEP_NICHOLAS	
	const EVENT_BEAT_MOSSDEEP_VIRGIL
	const EVENT_BEAT_MOSSDEEP_MAURA
	const EVENT_BEAT_MOSSDEEP_SAMANTHA	
	const EVENT_BEAT_MOSSDEEP_MACEY	
	const EVENT_BEAT_MOSSDEEP_KATHLEEN	
	const EVENT_BEAT_MOSSDEEP_SYLVIA
	const EVENT_BEAT_MOSSDEEP_HANNAH

	;Sootopolis Gym
	const EVENT_BEAT_SOOTOPOLIS_CONNIE
	const EVENT_BEAT_SOOTOPOLIS_ANDREA
	const EVENT_BEAT_SOOTOPOLIS_DAPHNE
	const EVENT_BEAT_SOOTOPOLIS_ANNIKA
	const EVENT_BEAT_SOOTOPOLIS_TIFFANY
	const EVENT_BEAT_SOOTOPOLIS_CRISSY
	const EVENT_BEAT_SOOTOPOLIS_BETHANY
	const EVENT_BEAT_SOOTOPOLIS_OLIVIA
	const EVENT_BEAT_SOOTOPOLIS_BRIANNA
	const EVENT_BEAT_SOOTOPOLIS_BRIDGET

	;Mount Moon Trainers

	const EVENT_BEAT_MOON_KENT
	const EVENT_BEAT_MOON_IRIS
	const EVENT_BEAT_MOON_JOVAN
	const EVENT_BEAT_MOON_ROBBY
	const EVENT_BEAT_MOON_MIRIAM
	const EVENT_BEAT_MOON_JOSH
	const EVENT_BEAT_MOON_MARCOS
	const EVENT_BEAT_MOON_GRUNT1
	const EVENT_BEAT_MOON_GRUNT2
	const EVENT_BEAT_MOON_GRUNT3
	const EVENT_BEAT_MOON_GRUNT4
	const EVENT_BEAT_MOON_MIGUEL

	;Safari Zone Trainers

	const EVENT_BEAT_SAFARI_ELI
	const EVENT_BEAT_SAFARI_RANDAL
	const EVENT_BEAT_SAFARI_STEVEN
	const EVENT_BEAT_SAFARI_MONICA
	const EVENT_BEAT_SAFARI_TINA
	const EVENT_BEAT_SAFARI_RACHAEL
	const EVENT_BEAT_SAFARI_JOEY
	const EVENT_BEAT_SAFARI_ROSS
	const EVENT_BEAT_SAFARI_CHANDLER

	const EVENT_BEAT_SAFARI_GRUNT1
	const EVENT_BEAT_SAFARI_GRUNT2
	const EVENT_BEAT_SAFARI_GRUNT3
	const EVENT_BEAT_SAFARI_GRUNT4
	const EVENT_BEAT_SAFARI_GRUNT5
	const EVENT_BEAT_SAFARI_GRUNT6
	const EVENT_BEAT_SAFARI_GRUNT7

	const EVENT_BEAT_SAFARI_GRUNTF1
	const EVENT_BEAT_SAFARI_GRUNTF2
	const EVENT_BEAT_SAFARI_GRUNTF3
	const EVENT_BEAT_SAFARI_GRUNTF4
	const EVENT_BEAT_SAFARI_GRUNTF5

	const EVENT_BEAT_SAFARI_ROCKETS
	const GOT_REWARDS_FROM_SAFARI_WARDEN

	const EVENT_SAFARI_WEST_FAKE_MEW
	const EVENT_SAFARI_EAST_FAKE_MEW
	const EVENT_SAFARI_SOUTH_FAKE_MEW
	const EVENT_HIDE_SAFARI_MEW

	const EVENT_BEAT_ELITE_4_SIDNEY
	const EVENT_BEAT_ELITE_4_PHOEBE
	const EVENT_BEAT_ELITE_4_GLACIA
	const EVENT_BEAT_ELITE_4_DRAKE
	const EVENT_BEAT_CHAMPION_STEVEN

	const EVENT_BEAT_INDIGO_LEAGUE
	const EVENT_BEAT_HOENN_LEAGUE

	const EVENT_HIDE_EASY_TRAINERS
...
; New to Crystal
	...
	const EVENT_WORLD_CUP_REGISTERED
	const EVENT_BEAT_QUALIFIER_ROUND_ONE
	const EVENT_BEAT_QUALIFIER_ROUND_TWO
	const EVENT_BEAT_QUALIFIER_ROUND_THREE
	const EVENT_WORLD_CUP_QUALIFIED
	const EVENT_WORLD_CUP_BEAT_ROUND_ONE
	const EVENT_WORLD_CUP_BEAT_ROUND_TWO
	...
	const EVENT_FOUND_LILYCOVE_WALLY
	const EVENT_FOUND_VICTORY_ROAD_WALLY
	const_skip ; unused
	const_skip ; unused
	const_skip ; unused
	const_skip ; unused	
