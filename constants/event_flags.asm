...
; Johto story events
	...
	const EVENT_BOUGHT_MT_MOON_FEEBAS
...
; Johto hidden items
	...
	const EVENT_ILEX_WEST_GOLD_LEAF
	const EVENT_ILEX_WEST_MARVEL_SCALE
...
; Kanto itemballs
	...
	const EVENT_VIRIDIAN_FOREST_SILVER_LEAF
...
; New to Crystal
	...
	const EVENT_ILEX_FOREST_SILVER_LEAF
	...
	const EVENT_SILVER_CAVE_ROOM_2_GOLD_LEAF
	const EVENT_SILVER_CAVE_ROOM_2_ULTRA_BALL
	const EVENT_SILVER_CAVE_ROOM_2_MARVEL_SCALE
	...
	const EVENT_FOUND_ROUTE10_GREEN
	const_skip ; unused
	const_skip ; unused
	const_skip ; unused
	const_skip ; unused
