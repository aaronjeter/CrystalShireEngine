...
;Hoenn Trainer Flags
	...
	const EVENT_BEAT_SOUTH_PARK_IELLA

	const EVENT_BEAT_LATTICE_ROOF_JESS
	const EVENT_BEAT_LATTICE_ROOF_KLUTCH
	const EVENT_BEAT_LATTICE_ROOF_AMAYA
	const EVENT_BEAT_SOUTH_GYM_RODNEY

	const GOT_SOUTHSIDE_DELIBIRD
	const GOT_SOUTHSIDE_VULPIX
	const HELPED_LATTICEROOF_DANCER
	const GOT_CITY_SOUTH_PICHU
