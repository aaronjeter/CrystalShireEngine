...
; wHoennBadges
	const ENGINE_STONEBADGE
	const ENGINE_KNUCKLEBADGE
	const ENGINE_DYNAMOBADGE
	const ENGINE_HEATBADGE
	const ENGINE_BALANCEBADGE
	const ENGINE_FEATHERBADGE
	const ENGINE_MINDBADGE
	const ENGINE_RAINBADGE
; wUnlockedUnowns
...
; wVisitedSpawns
	...
	const ENGINE_FLYPOINT_LITTLEROOT
	const ENGINE_FLYPOINT_OLDALE
	const ENGINE_FLYPOINT_PETALBURG
	const ENGINE_FLYPOINT_RUSTBORO
	const ENGINE_FLYPOINT_DEWFORD
	const ENGINE_FLYPOINT_SLATEPORT
	const ENGINE_FLYPOINT_MAUVILLE
	const ENGINE_FLYPOINT_VERDANTURF
	const ENGINE_FLYPOINT_LAVARIDGE
	const ENGINE_FLYPOINT_FALLARBOR
	const ENGINE_FLYPOINT_FORTREE
	const ENGINE_FLYPOINT_LILYCOVE
	const ENGINE_FLYPOINT_MOSSDEEP
	const ENGINE_FLYPOINT_SOOTOPOLIS
	const ENGINE_FLYPOINT_PACIFIDLOG
	const ENGINE_FLYPOINT_EVERGRANDE
