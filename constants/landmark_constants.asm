...
DEF HOENN_LANDMARK EQU const_value
	const LANDMARK_LITTLEROOT
	const LANDMARK_OLDALE
	const LANDMARK_PETALBURG
	const LANDMARK_RUSTBORO
	const LANDMARK_DEWFORD
	const LANDMARK_SLATEPORT
	const LANDMARK_MAUVILLE
	const LANDMARK_VERDANTURF
	const LANDMARK_LAVARIDGE
	const LANDMARK_FALLARBOR
	const LANDMARK_FORTREE
	const LANDMARK_LILYCOVE
	const LANDMARK_MOSSDEEP
	const LANDMARK_SOOTOPOLIS
	const LANDMARK_PACIFIDLOG
	const LANDMARK_EVERGRANDE
	const LANDMARK_PETALBURG_WOODS
	const LANDMARK_RUSTURF_TUNNEL
	const LANDMARK_GRANITE_CAVE
	const LANDMARK_NEW_MAUVILLE
	const LANDMARK_LAVARIDGE_DESERT
	const LANDMARK_FIERY_PATH
	const LANDMARK_METEOR_FALLS
	const LANDMARK_MT_PYRE
	const LANDMARK_ROUTE_101
	const LANDMARK_ROUTE_102
	const LANDMARK_ROUTE_103
	const LANDMARK_ROUTE_104
	const LANDMARK_ROUTE_105
	const LANDMARK_ROUTE_108
	const LANDMARK_ROUTE_109
	const LANDMARK_ROUTE_110
	const LANDMARK_ROUTE_111
	const LANDMARK_ROUTE_112
	const LANDMARK_ROUTE_113
	const LANDMARK_ROUTE_114
	const LANDMARK_ROUTE_115
	const LANDMARK_ROUTE_116
	const LANDMARK_ROUTE_117
	const LANDMARK_ROUTE_118
	const LANDMARK_ROUTE_119
	const LANDMARK_ROUTE_120
	const LANDMARK_ROUTE_121
	const LANDMARK_ROUTE_122
	const LANDMARK_ROUTE_123
